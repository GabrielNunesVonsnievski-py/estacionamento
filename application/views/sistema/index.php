                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mg-20">
                                        ...
                                        <div class="col-md-6 mg-20">
                                            ...
                                            <input type="text" class="form-control" name="sistema_nome_fantasia" value="<?php echo (isset($sistema) ? $sistema->sistema_nome_fantasia : set_value('sistema_nome_fantasiaf')); ?>">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3 mg-20">
                                            ...
                                            <div class="col-md-3 mg-20">
                                                <label>Inscrição Estadudal</label>
