    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-block"><a data-toggle="tooltip" data-placement="right" title="Cadastrar <?php echo $this->router->fetch_class() ?>" class="btn bg-blue float-right text-white " href="<?php echo base_url($this->router->fetch_class() . '/core/'); ?>">Cadastrar Tickets</a></div>
                        <div class="card-body">
                                    ...
                                    <?php foreach ($estacionados as $estacionado): ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <button data-toggle="modal" data-target="#estacionado-<?php echo $estacionado->estacionar_id; ?>" data-placement="bottom" title="Excluir <?php echo $this->router->fetch_class() ?>" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#exampleModalCenter"><i class="ik ik-trash-2"></i></button> 
                                            </td>
                                        </tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-block text-center">SITUAÇÂO VAGAS</div>
                        <div class="card-body">
                            <div class="row">
                            <div class="col-lg-3 col-md-4 col-6">
                                <p class="text-center text-uppercase small">Veículo Pequeno<?php echo ($numero_vagas_pequeno->precificacao_ativa == 0 ? '<span class="text-danger font-weight-bold">&nbsp;<i class="fas fa-ban"></i>&nbsp;Desativada</span>' : ''); ?></p>
                                            ...
                                            <?php for($i = 1; $i <= $numero_vagas_pequeno->vagas; $i++): ?>    
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <div class="widget social-widget bg-warning vaga">
                                                        <div class="widget-body">
                                                            <div data-toggle="tooltip" data_placement="bottom" title="Placa&nbsp;<?php echo $placas[$i]  ?>" class="content">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="widget-body">
                                                            <div data-toggle="tooltip" data_placement="bottom" title="<?php echo($numero_vagas_pequeno->precificacao_ativa == 0 ? 'Desativada' : 'Livre' ); ?>" class="content">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <p class="text-center text-uppercase small">Veículo Médio<?php echo ($numero_vagas_medio->precificacao_ativa == 0 ? '<span class="text-danger font-weight-bold">&nbsp;<i class="fas fa-ban"></i>&nbsp;Desativada</span>' : ''); ?></p>
                                <div class="widget social-widget">
                                    <div class="widget-body">
                                        <div class="content">
                                            ...
                                            <?php for($i = 1; $i <= $numero_vagas_medio->vagas; $i++): ?>   
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="widget-body">
                                                        <div data-toggle="tooltip" data_placement="bottom" title="<?php echo($numero_vagas_medio->precificacao_ativa == 0 ? 'Desativada' : 'Livre' ); ?>" class="content">
                                            ...
                                            <?php for($i = 1; $i <= $numero_vagas_grande->vagas; $i++): ?>   
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="widget-body">
                                                            <div data-toggle="tooltip" data_placement="bottom" title="<?php echo($numero_vagas_grande->precificacao_ativa == 0 ? 'Desativada' : 'Livre' ); ?>" class="content">
                                            ...
                                            <?php for($i = 1; $i <= $numero_vagas_moto->vagas; $i++): ?>    
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <div class="widget social-widget <?php echo($numero_vagas_moto->precificacao_ativa == 0 ? 'bg-google' : 'bg-success' ); ?> vaga">
                                                        <div class="widget-body">
                                                        <div data-toggle="tooltip" data_placement="bottom" title="<?php echo($numero_vagas_moto->precificacao_ativa == 0 ? 'Desativada' : 'Livre' ); ?>" class="content">
