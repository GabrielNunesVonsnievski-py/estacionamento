                                ...
                                <?php if ($this->ion_auth->is_admin()): ?>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 mg-20">
                                            ...
                                            <select class="form-group" name="perfil">
                                                <?php if (isset($usuario)): ?>

                                                    <option value="1" <?php echo ($perfil_usuario->id == 2 ? 'selected' : ''); ?>>Administrador</option>
                                                    <option value="2" <?php echo ($perfil_usuario->id == 1 ? 'selected' : ''); ?>>Atendende</option>
