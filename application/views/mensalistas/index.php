    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-block"><a data-toggle="tooltip" data-placement="right" title="Cadastrar <?php echo $this->router->fetch_class() ?>" class="btn bg-blue float-right text-white " href="<?php echo base_url($this->router->fetch_class() . '/core/'); ?>">Cadastrar Mensalistas</a></div>
                        <div class="card-body">
                                        ...
                                        <?php foreach ($mensalistas as $mensalista): ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <button data-toggle="modal" data-target="#mensalista-<?php echo $mensalista->mensalista_id; ?>" data-placement="bottom" title="Excluir <?php echo $this->router->fetch_class() ?>" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#exampleModalCenter"><i class="ik ik-trash-2"></i></button> 
                                                </td>
                                            </tr>
